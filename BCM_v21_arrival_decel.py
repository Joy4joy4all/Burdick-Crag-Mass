...
def get_arrival_profile(step, total_steps, profile="standard"):
    """
...
def main():
    ...
    parser.add_argument("--profile", type=str, default="standard",
                        choices=["standard", "hot", "deep", "gentle"],
                        help="Arrival profile variant")
    ...
    if target == "bh":
        ...
        profile_fn = lambda s, t: get_arrival_profile(s, t, arrival_profile)
        target_name = f"Galaxy arrival [{arrival_profile}]"
        settle_window = 1200
    else:
    ...
    print(f"\n{'='*65}")
    print(f"  BCM v21.3 -- ARRIVAL DECELERATION TEST")
    print(f"  Boundary layer operator (Jasper Beach)")
